...
CREATE TABLE Sales (
ID INT NOT NULL PRIMARY KEY, Salesperson VARCHAR(128), Sales_Date VARCHAR(128),
Customer_name VARCHAR(128), Address VARCHAR(128), 
Phone BIGINT, POC_name VARCHAR(128), 
POC_title VARCHAR(128), POC_phone VARCHAR(128), 
POC_email VARCHAR(128), Call_type VARCHAR(128), 
POC_reseller_name VARCHAR(128), POC_reseller_org VARCHAR(128),
POC_reseller_phone INT, POC_reseller_email VARCHAR(128), 
POC_reseller_fee INT, Opportunities VARCHAR(128),
Bandwidth_req VARCHAR(128), IP_ammount INT,
Bandwidth_current VARCHAR(128), Current_provider VARCHAR(128),
Current_monthly_charge INT, Current_technology VARCHAR(128), 
TowerCoverage VARCHAR(128), Notes VARCHAR(255)
);
...
ID INT NOT NULL FOREIGN KEY REFERENCES Sales(ID),
Existing_infrastructure VARCHAR(255), /*!!!!!!!!!!!!!!!!!!!!!LOOOK AT THIS LATER!!!!!!!!!!!!!!!!*/
Survey VARCHAR(128), TX_radio VARCHAR(128),
RX_radio VARCHAR(128), Existing_sector VARCHAR(128),
Throughput VARCHAR(128), RSSI VARCHAR(128),
Parts_list TEXT, Notes VARCHAR(128),
Dist_install_labor VARCHAR(128), CPE_install_labor VARCHAR(128)
);
